...
#define NUM_FLOAT_VARS 78	///< Number of variables that will be logged as floats
...
char* saveAsFloatNames[NUM_FLOAT_VARS] = {
			...
			"dthr_in","de_in", "dr_in", "da_l_in", "da_r_in",
			"de", "da_l", "da_r",
			"df_l", "df_r", "dr", "dthr",
...
double* saveAsFloatPointers[NUM_FLOAT_VARS] = {
			...
			&controlData.dthr_in, &controlData.de_in, &controlData.dr_in,  &controlData.da_l_in, &controlData.da_r_in,
