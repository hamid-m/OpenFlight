...
void init_researchNav(struct sensordata *sensorData_ptr, struct nav *navData_ptr, struct researchNav *researchNavData_ptr){
...
void get_researchNav(struct sensordata *sensorData_ptr, struct nav *navData_ptr, struct researchNav *researchNavData_ptr){
