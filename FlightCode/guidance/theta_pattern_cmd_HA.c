...
extern void get_guidance(double time, struct sensordata *sensorData_ptr, struct nav *navData_ptr, struct control *controlData_ptr, struct mission *missionData_ptr){
                                ...
                                if( time >= 2 && time < 3.5){
                                        controlData_ptr->theta_cmd =      -2*D2R*1.5;
                                }
                                if( time >= 3.5 && time < 5){
                                        controlData_ptr->theta_cmd =      4*D2R*1.5;
                                }
                                if( time >= 5 && time < 6){
                                        controlData_ptr->theta_cmd =      -1*D2R*1.5;
                                }
                                if( time >= 6 && time < 8){
                                        controlData_ptr->theta_cmd =      -3*D2R*1.5;
                                }
                                if( time >= 8 && time < 10){
                                        controlData_ptr->theta_cmd =      4*D2R*1.5;
                                }
                                if( time >= 10 && time < 11){
                                        controlData_ptr->theta_cmd =      6*D2R*1.5;
                                }   
                                if( time >= 11 && time < 13){
                                        controlData_ptr->theta_cmd =      0;
                                }
								if( time >= 13 && time < 14.5){
                                        controlData_ptr->theta_cmd =      -5*D2R*1.5;
                                }
